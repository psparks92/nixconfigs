...
-- Optional: Add a keybinding to toggle background
vim.api.nvim_set_keymap("n", "<leader>tb", ":ToggleBackground<CR>", { noremap = true, silent = true })
